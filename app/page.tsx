export default function Home() {
  return (
    <div className="min-h-screen pb-24">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <button className="bg-yellow-400 hover:bg-yellow-500 text-blue-900 font-bold text-lg px-8 py-4 rounded-full shadow-2xl transform hover:scale-105 transition-all duration-200">
                🎵 Start met luisteren
              </button>
            </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* FM Rotterdam */}
            <div className="bg-gradient-to-br from-yellow-400 to-yellow-500 p-8 rounded-3xl shadow-xl transform hover:scale-105 hover:rotate-1 transition-all duration-300">
              ...
              <div className="mt-4 bg-blue-900 text-yellow-400 px-4 py-2 rounded-full text-sm font-bold inline-block">
                Beschikbaar
              </div>
            </div>

            {/* FM Den Haag */}
            <div className="bg-gradient-to-br from-yellow-400 to-yellow-500 p-8 rounded-3xl shadow-xl transform hover:scale-105 hover:rotate-1 transition-all duration-300 relative overflow-hidden">
              <div className="text-6xl mb-4">📻</div>
            ...
            {/* DAB+ */}
            <div className="bg-gradient-to-br from-blue-600 to-blue-800 p-8 rounded-3xl shadow-xl transform hover:scale-105 hover:rotate-1 transition-all duration-300">
              <div className="text-6xl mb-4">📡</div>
              <h3 className="text-3xl font-bold text-yellow-400 mb-2">DAB+</h3>
              <p className="text-yellow-200 font-semibold">Digitale radio</p>
              <div className="mt-4 bg-yellow-400 text-blue-900 px-4 py-2 rounded-full text-sm font-bold inline-block">
                Beschikbaar
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/10 backdrop-blur-lg p-8 rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold text-yellow-400 mb-4">Beste Muziek</h3>
            ...
            <div className="bg-white/10 backdrop-blur-lg p-8 rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-300">
              <div className="text-5xl mb-4">📰</div>
              <h3 className="text-2xl font-bold text-yellow-400 mb-4">Lokaal Nieuws</h3>
              <p className="text-blue-100">
            ...
            <div className="bg-white/10 backdrop-blur-lg p-8 rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold text-yellow-400 mb-4">Leuke Shows</h3>
              <p className="text-blue-100">
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 bg-gradient-to-r from-yellow-400 via-yellow-300 to-yellow-400">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <div className="bg-blue-900 text-yellow-400 px-6 py-3 rounded-full font-bold">
              🌅 24/7 Online
            </div>
            <div className="bg-blue-900 text-yellow-400 px-6 py-3 rounded-full font-bold">
              🎵 Geen Reclame
